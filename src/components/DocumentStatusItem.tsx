...
const DocumentStatusItem = (props: any) => {
  ...
  const isActive = item?.serviceRunning;
    ...
    <View style={styles(theme).statusItem}>
      ...
      <View style={styles(theme).timelineContainer}>
       ...
       {!isCompleted&& <View
          style={[
            styles(theme).circle,
            isCompleted && styles(theme).completedCircle,
            isActive && styles(theme).activeCircle,
            isRejected && styles(theme).rejectedCircle,
          ]}
        >
            {isActive || isRejected && 
            <View 
            style={
                {backgroundColor: isRejected ? 
                 '#E53935' :"#10B981" ,borderRadius:100,height:getScaleSize(12),width:getScaleSize(12),alignSelf:'center'}}/>}
            </View>
            }
          {isCompleted && (
           <Image source={IMAGES.status_green} style={{height:getScaleSize(18),width:getScaleSize(18),}} />
          )}
        ...
        {!isLast && (
          <View
            style={[
              styles(theme).line,
              isActive && styles(theme).activeLine,
              isRejected && styles(theme).rejectedLine,
            ]}
          />
        )}
      </View>
