    ...
    <View style={{flexDirection:'row', alignItems:'center', gap:getScaleSize(12)}}>
     ...
     source={{uri:data?.service_image}}
      ...
      <View style={{gap:getScaleSize(6)}}>
        ...
        >{"Washroom Cleaning"}</Text>
      </View>
      
    </View>
    <View style={{height:1,backgroundColor:"#D6D6D6",flex:1,marginVertical:getScaleSize(20)}} />
...
<View style={{flexDirection:'row',alignItems:'center',justifyContent:'space-between',marginTop:getScaleSize(16)}}>
  <TouchableOpacity
  style={{
    width:"48%",
