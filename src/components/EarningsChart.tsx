        ...
        <View style={{ padding: getScaleSize(24) }}>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                <Text
                    ...
                    color={theme.primary}>Earnings</Text>
                <TouchableOpacity
                    style={{ padding: getScaleSize(10), borderRadius: getScaleSize(10), flexDirection: 'row', alignItems: 'center', borderWidth: 1, borderColor: theme._B3B3B3 }}
                    onPress={onMonthPress}>
                    <Text
                        size={getScaleSize(12)}
                        font={FONTS.Lato.SemiBold}
                        color={theme._8C8C8C}>{data?.month ?? ''}
                    </Text>
                    <Image source={IMAGES.down} tintColor={theme._8C8C8C} style={{ marginLeft: getScaleSize(4), width: getScaleSize(16), height: getScaleSize(16) }} resizeMode="contain" />
                </TouchableOpacity>
            </View>
